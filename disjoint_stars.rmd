...
method of iteration over constellations avoids double counting.
...
```{python}
# Given a constellation (stell), this function returns its matching sequence in the
...
permutations. So for now, we iterate over all constellations with matching number
...
# forests that match the above description. The constellations in the output are
